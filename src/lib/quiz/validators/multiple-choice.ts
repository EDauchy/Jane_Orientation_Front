...
> = {
  ...
  "qcm-rhythm": {
    ...
    options: [
      ...
      {
        value: "flexible",
        label: "Totalement flexible, je gère selon l'envie",
      },
    ],
  },
  "qcm-group-role": {
  ...
  "qcm-stress": {
    ...
    options: [
      {
        value: "triage",
        label: "Je priorise et j'attaque une chose à la fois",
      },
  ...
  "qcm-satisfaction": {
    ...
    options: [
      ...
      {
        value: "create",
        label: "Avoir fait exister quelque chose qui n'existait pas",
      },
    ],
  },
};
