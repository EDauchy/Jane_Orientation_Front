...
export const MODULES: ReadonlyArray<ModuleConfig> = [
  ...
  {
    slug: "alternative-uses",
    component: "AlternativeUses",
    time: 75,
    category: "behavioral",
  },
  {
    slug: "tradeoff",
    component: "TradeoffScenario",
    time: 180,
    category: "behavioral",
  },
  {
    slug: "values-ranking",
    component: "ValuesRanking",
    time: 120,
    category: "values",
  },
  ...
  {
    slug: "open-projection",
    component: "OpenQuestion",
    time: 60,
    category: "open",
  },
  {
    slug: "open-blank-page",
    component: "OpenQuestion",
    time: 60,
    category: "open",
    hidden: true,
