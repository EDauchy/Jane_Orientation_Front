...
const team = [
  {
    name: "KHACHNANE Adenan",
    role: "Développeur Full-Stack",
    school: "Étudiant en Mastère 1",
    img: "/img-homme.png",
  },
  {
    name: "BONEFONS Alexandre",
    role: "Développeur Full-Stack",
    school: "Étudiant en Mastère 1",
    img: "/img-homme.png",
  },
  {
    name: "CARTEGNIE Nathan",
    role: "Développeur Full-Stack",
    school: "Étudiant en Mastère 1",
    img: "/img-homme.png",
  },
  ...
  {
    name: "EYEANG ZEHRI Najiba Laure",
    role: "Développeur Full-Stack",
    school: "Étudiant en Mastère 1",
    img: "/img-homme.png",
  },
...
const TeamCard = ({
  ...
  <div className="w-70 flex flex-col items-center bg-white border border-gray-100 rounded-3xl p-4 shadow-sm w-50px">
    ...
    <p className="font-montserrat font-black text-primary uppercase text-2xl tracking-wide text-center">
      {name}
    </p>
    <span className="mt-1 bg-primary text-white text-[10px] font-semibold px-3 py-0.5 rounded-full">
      {role}
    </span>
    <p className="font-roboto font-semibold text-gray-400 text-[11px] mt-1">
      {school}
    </p>
  </div>
);
        ...
        <div className="relative max-w-2xl mx-auto bg-primary rounded-3xl px-8 py-10 text-center text-white mt-10">
          ...
          <div className="absolute flex flex-col items-center px-5 py-2 rounded-2xl -left-5 -top-5 bg-white/20 backdrop-blur-md shadow-xl">
            <div className="flex -space-x-2 mb-1">
              {["/img-homme.png", "/img-femme.png", "/img-homme.png"].map(
                (src, i) => (
                  <img
                    key={i}
                    src={src}
            ...
            <p className="font-roboto font-semibold text-white/80 text-[10px] leading-tight">
              Utilisateurs actifs
            </p>
          </div>
          ...
          <p className="font-roboto font-semibold text-white/90 text-sm md:text-base leading-relaxed">
            Nous sommes une équipe de cinq développeurs passionnés issus de Ynov
            Campus, composée de quatre développeurs full-stack et d'un
            développeur front-end. Dans le cadre de notre formation, nous avons
            donné vie à Jane Orientation, un projet innovant conçu et suivi par
            notre école. Notre mission est de créer des solutions technologiques
            intuitives pour accompagner et orienter les utilisateurs dans leurs
            choix, avec engagement et créativité.
          </p>
      ...
      <section className="py-16 px-6 md:px-12 lg:px-24">
        ...
        <div className="max-w-xl mx-auto bg-brand-orange rounded-3xl px-8 py-10 text-white text-center">
          <p className="font-roboto font-semibold text-sm md:text-base leading-relaxed mb-6">
            Nous sommes à votre écoute ! Si vous avez des questions, des
            suggestions ou simplement envie de nous contacter, n'hésitez pas.
            Ensemble, nous construisons un projet qui répond à vos besoins.
          </p>
          <Link
            to="/contact"
