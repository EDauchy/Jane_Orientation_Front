    ...
    <div className="relative lg:w-1/2 w-full ">
      ...
      <div className="w-full rounded-2xl py-6 px-4 bg-white relative pt-12 shadow-[0px_2px_8px_rgba(99,99,99,0.2)]">
        <p className="text-md font-extrabold leading-tight text-[#F8A128]">
          ...
          <span className="px-1 rounded-full border-3 border-[#F8A128] text-[#F8A128] bg-white align-middle leading-none">
            aventure
          </span>{" "}
          ...
          <span className="ml-0.5 px-1 rounded-lg border-3 border-[#F8A128] bg-white inline-block mt-1 text-[#F8A128]">
            exclusivité!
          </span>
        </p>
