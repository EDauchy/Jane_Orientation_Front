...
const PowerByApisCard = () => {
  return (
    <div className="lg:w-1/2 w-full bg-[#37cd8e] shadow-[0px_2px_8px_rgba(99,99,99,0.2)] rounded-2xl pt-6 pb-4 px-6 flex flex-col  lg:gap-0 gap-8 justify-between">
      ...
      <div className="flex items-center flex-nowrap md:flex-wrap sm:flex-wrap space-x-4">
        ...
        <img src={"./openai_logo.png"} alt="Logo OpenAI" className="h-7" />

        {/* Logo Onisep (Dimensions ajustées) */}
        <img src={"./onisep_logo.png"} alt="Logo ONISEP" className="h-7" />

        <img src={"./crous_logo.png"} alt="Logo Les Crous" className="h-12" />
      </div>
    </div>
  );
};
