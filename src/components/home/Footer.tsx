...
export default function Footer() {
  ...
  return (
    <>
      <div className="relative w-full flex p-10 lg:flex-row flex-col-reverse ">
        <div className="xl:w-2/3 lg:w-3/5 w-full bg-primary rounded-[25px] lg:rounded-br-none lg:rounded-t-[25px] md:rounded-tl-[25px] rounded-t-none p-7 pb-20 ">
          <div className="grid md:grid-cols-2 grid-cols-1 gap-y-20 gap-x-26 w-fit md:gap-16 ">
          ...
          <div className="lg:flex-1 lg:w-full md:w-1/2 pb-5 lg:pl-5 ">
            <div className="flex flex-col gap-3 bg-[#74F3BF] py-10 px-6 h-full rounded-[25px]">
              ...
              <p className="text-primary text-sm">
                <span className="ml-0.5 px-1 rounded-lg border-3 border-primary font-bold shadow-md inline-block mt-1 ">
                ...
                pourraient{" "}
                <span className="px-1 rounded-full border-3 border-primary font-bold">
    ...
    >
      <path d="M12 22V2M12 2l-10 10M12 2l10 10" />
          ...
          <div className="relative lg:w-full md:w-1/2 flex flex-col justify-between items-end bg-primary lg:rounded-r-[25px] rounded-t-[25px] p-3 text-white">
            ...
            <div className="absolute lg:block hidden left-0 bottom-[25px] w-[25px] h-full bg-[radial-gradient(circle_at_top_right,transparent_25px,#681BEF_25px)]"></div>
            <img
              src="./homme-fauteuil-roulant.png"
              className="absolute bottom-0 rotate-y-180 lg:right-[70%] right-[50%] lg:w-[200%] w-[70%]"
              alt="Illustration"
            />
          </div>
        </div>
