      ...
      <div className="bg-white rounded-2xl w-full max-w-5xl shadow-2xl flex flex-col max-h-[90vh]">
        ...
        <div className="flex justify-between items-center p-6 border-b border-gray-200">
          <div>
            ...
            <p className="text-sm text-gray-500 mt-1">Profession : {job}</p>
          </div>
          <button
            onClick={onClose}
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <p className="text-sm text-gray-600 mt-0.5">
                            ...
                            {pro.user_b_details.years_experience && (
                              <span className="text-gray-400 ml-2">• {pro.user_b_details.years_experience} ans d'exp.</span>
                            )}
                          </p>
                      ...
                      <div className="flex flex-col gap-3 lg:min-w-[420px]">
                        ...
                        <div className="flex gap-2">
                          ...
                          <div className="w-32">
                            ...
                            <select
                              className="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm bg-white hover:bg-gray-50 transition-colors disabled:bg-gray-100 disabled:cursor-not-allowed"
                              onChange={(e) => {
                              ...
                              value={isThisProSelected && selectedDate && selectedDate.includes('T') ? new Date(selectedDate).getHours().toString().padStart(2, '0') : ''}
                            >
                              <option value="">--:--</option>
                        ...
                        {!isAvailableDay && datePart && isThisProSelected && (
                          <div className="flex items-center gap-2 px-3 py-2 bg-red-50 border border-red-200 rounded-lg">
                            ...
                            <span className="text-xs text-red-700 font-medium">Professionnel non disponible ce jour</span>
                          </div>
                        )}
