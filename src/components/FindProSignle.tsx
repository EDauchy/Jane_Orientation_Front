  ...
  const getBookingStatus = () => {
    ...
    const professionCount = userAppointments.filter(
      (a) =>
        ...
        a.user_b?.user_b_details?.profession ===
        ...
        <Box sx={modalStyle}>
          ...
          <div className="flex justify-between items-center p-6 border-b border-gray-200 shrink-0">
            <div>
              ...
              <p className="mt-1">
                Profession : {professional.user_b_details.profession}
              </p>
            </div>
            <button
              onClick={onClose}
                    ...
                    <p className="text-sm text-gray-600 mt-0.5">
                      ...
                      {professional.user_b_details.years_experience && (
                        <span className="text-gray-400 ml-2">
                          • {professional.user_b_details.years_experience} ans
                          d'exp.
                        </span>
                      )}
                    </p>
